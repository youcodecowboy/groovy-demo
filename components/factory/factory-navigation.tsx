...
import { Menu, Package, Search, BarChart3, Home, MessageSquare } from "lucide-react"
...
const navigationItems = [
  ...
  },
  {
    ...
    href: "/floor/items",
    icon: Package,
    description: "Browse all production items",
  },
  {
    title: "Item Search",
    href: "/floor/search",
  ...
  {
    title: "Messages",
    href: "/floor/messaging",
    icon: MessageSquare,
    description: "Communicate with admin and team",
  },
]

export function FactoryNavigation() {
