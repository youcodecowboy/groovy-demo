...
export const mockBrandOrders: BrandOrder[] = [
  {
    ...
    totalItems: 1000,
    defectRate: 2.3,
    promisedDelivery: addDays(new Date(), 14),
    value: 45000,
    currency: 'USD',
  ...
  },
  {
    ...
    totalItems: 500,
    defectRate: 1.8,
    promisedDelivery: addDays(new Date(), 7),
    value: 28000,
    currency: 'USD',
  ...
  },
  {
    ...
    totalItems: 1200,
    defectRate: 0.5,
    promisedDelivery: subDays(new Date(), 3),
    actualDelivery: subDays(new Date(), 2),
    value: 67000,
    currency: 'USD',
  ...
  },
  {
    ...
    totalItems: 800,
    defectRate: 0,
    promisedDelivery: addDays(new Date(), 28),
    value: 32000,
    currency: 'USD',
  ...
  },
  {
    ...
    totalItems: 600,
    defectRate: 1.2,
    promisedDelivery: subDays(new Date(), 10),
    actualDelivery: subDays(new Date(), 8),
    value: 41000,
    currency: 'USD',
    createdAt: subDays(new Date(), 56),
...
export const mockBrandThreads: BrandThread[] = [
  ...
  },
  {
    ...
    lastMessage: subDays(new Date(), 1),
    unreadCount: 0,
    hasAttachments: true,
  ...
  },
  {
    ...
    lastMessage: subDays(new Date(), 3),
    unreadCount: 1,
