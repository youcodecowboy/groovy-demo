...
export default function AWBGeneratorPage() {
  const [awb, setAWB] = useState<AWBData>({
    ...
    shipper: {
      ...
      email: "shipping@skywalker-textiles.com"
    },
    consignee: {
      name: "",
      address: "",
    ...
    <div className="container mx-auto p-6 max-w-6xl">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-600">Create professional air waybills for international shipping</p>
        </div>
      </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Textarea
                  id="description"
                  placeholder="Textile products - Jedi robes"
