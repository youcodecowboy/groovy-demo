...
interface ComplianceTemplate {
  id: string
  name: string
  category: 'export' | 'safety' | 'environmental' | 'quality' | 'labor' | 'brand'
  region: string
  description: string
...
const mockTemplates: ComplianceTemplate[] = [
  {
    id: "1",
    name: "Brand Compliance Declaration",
    category: "brand",
    region: "Global",
    description: "Declaration of brand standards and compliance requirements",
    requiredFields: ["Brand Name", "Brand Standards", "Compliance Officer", "Audit Results", "Certification Body"],
    template: `BRAND COMPLIANCE DECLARATION

BRAND INFORMATION:
Brand Name: {{brandname}}
Brand Owner: {{brandowner}}
Brand Registration Number: {{brandregistrationnumber}}

BRAND STANDARDS COMPLIANCE:
We hereby declare that our brand operations comply with all applicable brand standards and requirements.

BRAND STANDARDS:
Brand Guidelines: {{brandguidelines}}
Quality Standards: {{qualitystandards}}
Sustainability Requirements: {{sustainabilityrequirements}}
Ethical Sourcing: {{ethicalsourcing}}

COMPLIANCE OFFICER:
Name: {{complianceofficer}}
Title: {{complianceofficertitle}}
Contact: {{complianceofficercontact}}

AUDIT RESULTS:
Internal Brand Audit: {{internalbrandaudit}}
...
PREFERENCE CRITERION: {{preferencecriterion}}
...
Age Group: {{agegroup}}
Model/Style Number: {{modelstylenumber}}
...
MANAGEMENT SYSTEM:
Management Representative: {{managementrepresentative}}
Quality Manual Reference: {{qualitymanualreference}}
Document Control System: {{documentcontrolsystem}}
...
- Risk-Based Thinking: {{riskbasedthinking}}
...
WORKING CONDITIONS:
Maximum Working Hours: {{maximumworkinghours}} hours per week
Overtime Policy: {{overtimepolicy}}
Rest Days: {{restdays}} per week
Break Periods: {{breakperiods}}

COMPENSATION:
Minimum Wage Compliance: {{minimumwagecompliance}}
...
Non-Discrimination Policy: {{nondiscriminationpolicy}}
Grievance Mechanism: {{grievancemechanism}}
Child Labor Policy: {{childlaborpolicy}}

CERTIFICATIONS:
Social Compliance Audit: {{socialcomplianceaudit}}
...
export default function ComplianceTemplatesPage() {
  ...
  const getCategoryColor = (category: string) => {
    switch (category) {
      ...
      case 'brand': return 'bg-indigo-100 text-indigo-800'
    ...
    <div className="container mx-auto p-6 max-w-7xl">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-600">Generate compliance documents for brand operations and international trade</p>
        </div>
      </div>
                ...
                <div>
                  ...
                  <Select value={categoryFilter} onValueChange={setCategoryFilter}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="brand">Brand Compliance</SelectItem>
                    ...
                    {selectedTemplate.requiredFields.map((field) => {
                      ...
                      return (
                        <div key={field}>
                          ...
                          {field.includes('Address') || field.includes('Description') || field.includes('Policy') || field.includes('Standards') ? (
                            <Textarea
                              id={fieldKey}
