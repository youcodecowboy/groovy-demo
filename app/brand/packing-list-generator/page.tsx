    ...
    <div className="container mx-auto p-6 max-w-6xl">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-600">Create detailed packing lists for brand shipments</p>
        </div>
      </div>
          ...
          <Card>
            ...
            <CardContent>
              <div>
                ...
                <Textarea
                  id="notes"
                  placeholder="Handling instructions, brand protection requirements, certifications, etc."
