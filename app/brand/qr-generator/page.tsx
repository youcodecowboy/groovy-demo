...
import { QrCode, Download, Copy, Plus, Trash2, RefreshCw, Settings, Palette, FileText, Image } from "lucide-react"
    ...
    <div className="container mx-auto p-6 max-w-7xl space-y-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-600">Generate QR codes for brand products, marketing materials, and customer engagement</p>
        </div>
      </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <Textarea
                    id="content"
                    placeholder="Enter product URL, brand website, or marketing content"
                ...
                <div>
                  ...
                  <Input
                    id="label"
                    placeholder="Product name or campaign identifier"
