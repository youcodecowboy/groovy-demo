...
export default function POGeneratorPage() {
  const [po, setPO] = useState<PurchaseOrderData>({
    ...
    items: [{
      id: "1",
      sku: "BRAND-MAT-001",
      description: "Premium Brand Materials Package",
      quantity: 1,
      unitPrice: 500.00,
      total: 500.00,
    ...
    <div className="container mx-auto p-6 max-w-6xl">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-600">Create and manage purchase orders for brand materials and services</p>
        </div>
      </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Input
                  id="vendorName"
                  placeholder="Brand Materials Inc."
              ...
              <div>
                ...
                <Textarea
                  id="vendorAddress"
                  placeholder="789 Vendor Street, City, State 12345"
              ...
              <div>
                ...
                <Input
                  id="vendorEmail"
                  type="email"
                  placeholder="orders@brandmaterials.com"
                ...
                {po.items.map((item, index) => (
                  <div key={item.id} className="border rounded-lg p-4 space-y-3">
                    ...
                    <div>
                      ...
                      <Input
                        placeholder="Brand material or service description"
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Textarea
                  id="notes"
                  placeholder="Delivery instructions, quality requirements, brand specifications, etc."
                  value={po.notes}
