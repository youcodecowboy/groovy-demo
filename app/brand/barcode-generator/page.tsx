    ...
    <div className="container mx-auto p-6 max-w-7xl space-y-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-600">Generate barcodes for brand products, retail packaging, and inventory management</p>
        </div>
      </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <Input
                    id="content"
                    placeholder="Enter product SKU or barcode content"
